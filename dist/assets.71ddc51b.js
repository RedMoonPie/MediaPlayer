...
function () {
  ...
  function MediaPlayer(config) {
    //media player
    this.media = config.el; //plugins

    this.plugins = config.plugins || []; //inicializar los plugins

    this.initPlayer();
    this.initPlugins(); //booleano en true debido al autoplay
  ...
  MediaPlayer.prototype.initPlugins = function () {
    var _this = this; //cada plugin en el array plugins se inicializa 
...
function () {
  ...
  AutoPause.prototype.run = function (player) {
    ...
    observer.observe(player.media); //event visibility change
...
}]; //La clase Ads que maneja los anuncios

var Ads =
/** @class */
function () {
  //Implementacion de patron singleton con unica instancia 
  function Ads() {
    //Inicializar los Ads
    this.initAds();
  }
  ...
  Ads.prototype.initAds = function () {
    //Con el operador spread ponemos el objeto y hacemos una copia 
    this.ads = __spreadArrays(ALL_ADS);
  };

  Ads.prototype.getAd = function () {
    //obtener un Ad Especifico 
...
var ads_1 = __importDefault(require("./ads")); //clase del plugin de los ads 
...
function () {
  function AdsPlugin() {
    ...
    this.adsContainer = document.createElement('div'); //Handler 
  ...
  AdsPlugin.prototype.run = function (player) {
    ...
    this.media = this.player.media; //tiempo entre anuncios 
...
},{"./ads":"Plugins/Ads/ads.ts"}],"assets/index.ts":[function(require,module,exports) {
"use strict";
...
var Ads_1 = __importDefault(require("../Plugins/Ads/")); //seleccionamos el htmlElement video


var video = document.querySelector("video"); //se crea una nueva instancia del media player
...
button.onclick = function () {
  return player.p == false ? player.play() : player.pause();
}; //seleccionamos el boton mute del html


var buttonMute = document.querySelector('#muteButton');

buttonMute.onclick = function () {
  return player.media.muted == true ? player.media.muted = false : player.media.muted = true;
...
},{"./MediaPlayer":"assets/MediaPlayer.ts","../Plugins/Autoplay":"Plugins/Autoplay.ts","../Plugins/Autopause":"Plugins/Autopause.ts","../Plugins/Ads/":"Plugins/Ads/index.ts","./sw.js":[["assets/sw.js","assets/sw.js"],"assets/sw.js.map","assets/sw.js"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
