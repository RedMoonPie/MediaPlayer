    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            cache = _context.sent;
            return _context.abrupt("return", cache.addAll(['/', '/src/index.html', '/src/assets/index.js', '/src/assets/MediaPlayer.js', '/src/plugins/AutoPlay.js', '/src/plugins/AutoPause.js', '/src/assets/index.css', '/src/assets/BigBuckBunny.mp4']));
